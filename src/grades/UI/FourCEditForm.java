 ...
 * @author grant
 */
public class FourCEditForm extends JDialog{
    ...
    public FourCEditForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public FourCEditForm(Frame parent, String title, boolean modal){
   ...
   public void setAndEdit(){
       ...
       if(confirmButton.getText().equalsIgnoreCase("Confirm")){
              ...
              try{
           Database.editFourCEntry(grades);
           dispose();
      ...
      private void fireDatabaseUpdatedEvent(){
       FourthClassFrame mainWindow = (FourthClassFrame) getOwner();
