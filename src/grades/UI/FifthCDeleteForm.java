 ...
 * @author grant
 */
public class FifthCDeleteForm extends JDialog {
    ...
    public FifthCDeleteForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public FifthCDeleteForm(Frame parent, String title, boolean modal){
