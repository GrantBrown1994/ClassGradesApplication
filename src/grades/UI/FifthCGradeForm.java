 ...
 * @author grant
 */
public class FifthCGradeForm extends JDialog{
    ...
    public FifthCGradeForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public FifthCGradeForm(Frame parent, String title, boolean modal){
