 ...
 * @author grant
 */
public class FourCGradeForm extends JDialog {
    ...
    public FourCGradeForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public FourCGradeForm(Frame parent, String title, boolean modal){
