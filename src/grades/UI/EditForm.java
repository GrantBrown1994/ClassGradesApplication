...
public class EditForm extends JDialog {
    ...
    public EditForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public EditForm(Frame parent, String title, boolean modal){
   ...
   public void setAndEdit(){
      ...
      private void fireDatabaseUpdatedEvent(){
       FirstClassFrame mainWindow = (FirstClassFrame) getOwner();
