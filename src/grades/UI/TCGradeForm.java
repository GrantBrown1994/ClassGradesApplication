 ...
 * @author grant
 */
public class TCGradeForm extends JDialog {
    ...
    public TCGradeForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public TCGradeForm(Frame parent, String title, boolean modal){
