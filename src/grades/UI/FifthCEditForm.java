 ...
 * @author grant
 */
public class FifthCEditForm extends JDialog{
    ...
    public FifthCEditForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public FifthCEditForm(Frame parent, String title, boolean modal){
   ...
   public void setAndEdit(){
      ...
      private void fireDatabaseUpdatedEvent(){
       FifthClassFrame mainWindow = (FifthClassFrame) getOwner();
