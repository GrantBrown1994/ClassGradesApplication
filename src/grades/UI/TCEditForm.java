 ...
 * @author grant
 */
public class TCEditForm extends JDialog {
    ...
    public TCEditForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public TCEditForm(Frame parent, String title, boolean modal){
   ...
   public void setAndEdit(){
       ...
       if(confirmButton.getText().equalsIgnoreCase("Confirm")){
              ...
              try{
           Database.editThirdCEntry(grades);
           dispose();
      ...
      private void fireDatabaseUpdatedEvent(){
       ThirdClassFrame mainWindow = (ThirdClassFrame) getOwner();
