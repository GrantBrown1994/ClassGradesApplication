 ...
 * @author grant
 */
public class TCDeleteForm extends JDialog{
    ...
    public TCDeleteForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public TCDeleteForm(Frame parent, String title, boolean modal){
