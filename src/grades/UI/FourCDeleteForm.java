 ...
 * @author grant
 */
public class FourCDeleteForm extends JDialog{
    ...
    public FourCDeleteForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public FourCDeleteForm(Frame parent, String title, boolean modal){
