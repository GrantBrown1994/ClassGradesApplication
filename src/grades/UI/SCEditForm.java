 ...
 * @author grant
 */
public class SCEditForm extends JDialog{
    ...
    public SCEditForm(Frame parent, String title, boolean modal, Classes grades){
        super(parent,title,modal);
        componentsInside();
        this.grades = grades;
    }
    
    public SCEditForm(Frame parent, String title, boolean modal){
